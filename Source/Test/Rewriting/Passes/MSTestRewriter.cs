    ...
    internal class MSTestRewriter : AssemblyRewriter
    {
        ...
        internal void RewriteTestMethod(MethodDefinition method, MethodDefinition testMethod)
        {
            ...
            if (this.TestInitMethod != null)
            {
                ...
                FindMatchingMethodInDeclaringType(resolvedEngineType, "RegisterPerIterationInitMethod", this.Module.ImportReference(typeof(Action))));
            ...
            if (this.TestCleanupMethod != null)
            {
                ...
                FindMatchingMethodInDeclaringType(resolvedEngineType, "RegisterPerIterationCallBack", this.Module.ImportReference(typeof(Action))));
